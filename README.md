...
pixi add cuda-cudart cuda-cudart-dev cuda-cudart-dev_linux-64 cuda-cudart-static cuda-cudart-static_linux-64 cuda-cudart_linux-64 cuda-driver-dev cuda-driver-dev_linux-64
# for installing globally
pixi global install cuda-cudart cuda-cudart-dev cuda-cudart-dev_linux-64 cuda-cudart-static cuda-cudart-static_linux-64 cuda-cudart_linux-64 cuda-driver-dev cuda-driver-dev_linux-64
```
...
It is possible to list all of the versions of `cuda-cudart` available on your platform:
...
```
pixi search cuda-cudart --channel conda-forge
```
